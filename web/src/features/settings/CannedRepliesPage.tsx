...
import { useAdminMailboxes } from "@/lib/mailbox-admin";
    ...
    <div className="mx-auto max-w-3xl p-6">
      ...
      {replies.isPending ? (
        ...
        <EmptyState
          ...
          hint={adminErrorHint(replies.error) ?? getApiErrorMessage(replies.error)}
        />
      ) : (replies.data ?? []).length === 0 ? (
        <EmptyState
          icon={<MessageSquare className="size-8" />}
          title="No canned replies yet"
          hint="Add saved responses your team uses often."
        />
      ) : (

 ...
 *
 * <p>Refreshes against Identity's token endpoint. The platform has no record of the refresh token at
 * all — it only verifies access tokens against the published JWKS — so asking it to refresh would fail.
 *
